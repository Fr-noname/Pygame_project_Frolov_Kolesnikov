...
def berserk_init(player_pos, ALL_SPRITES):  # функция появления берсерка
    return Berserk(150, 100, 1.4, 3, 12, Axe(25, 100), ThrowingAxe(20, 20), RingOfPower, player_pos,
                   "Berserk.png", ALL_SPRITES)


def souleater_init(player_pos, ALL_SPRITES):  # функция появления пожир. душ
...
def general_init(player_pos, ALL_SPRITES):  # функция появления генерала
